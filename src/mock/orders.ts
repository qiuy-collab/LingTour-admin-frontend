...
export const mockOrders: Order[] = [
    ...
    items: [
      {
        productId: 'prod-0200',
        productName: '贝壳镶嵌首饰盒',
        productImage: 'https://picsum.photos/seed/seashell/200/200',
        quantity: 1,
        unitPrice: 32,
      },
      {
        productId: 'prod-0201',
        productName: '手工编织渔网袋',
        productImage: 'https://picsum.photos/seed/fishnet/200/200',
        quantity: 2,
        unitPrice: 18,
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        productId: 'prod-0202',
        productName: '凤凰单丛蜜兰香',
        productImage: 'https://picsum.photos/seed/dancong/200/200',
        quantity: 2,
        unitPrice: 45,
      },
      {
        productId: 'prod-0203',
        productName: '潮州朱泥手拉壶',
        productImage: 'https://picsum.photos/seed/teapot/200/200',
        quantity: 1,
        unitPrice: 88,
      },
    ],
    ...
    shippingAddress: {
      ...
      country: 'Singapore',
      city: 'Singapore',
      address: '456 Bukit Timah Road, #05-67',
      postalCode: '259712',
    },
  ...
  },
  {
    ...
    items: [
      {
        productId: 'prod-0204',
        productName: '满洲窗书签套装',
        productImage: 'https://picsum.photos/seed/bookmark/200/200',
        quantity: 3,
        unitPrice: 12,
      },
      {
        productId: 'prod-0205',
        productName: '客家蓝染围巾',
        productImage: 'https://picsum.photos/seed/indigo/200/200',
        quantity: 1,
        unitPrice: 28,
      },
    ],
    ...
    shippingAddress: {
      ...
      country: 'Singapore',
      city: 'Singapore',
      address: '789 East Coast Road, #08-12',
      postalCode: '459012',
    },
  ...
  },
  {
    ...
    shippingAddress: {
      ...
      country: 'Singapore',
      city: 'Singapore',
      address: '321 River Valley Road, #15-20',
      postalCode: '238301',
    },
  ...
  },
  {
    ...
    shippingAddress: {
      ...
      country: 'Singapore',
      city: 'Singapore',
      address: '567 Tampines Ave 5, #03-45',
      postalCode: '529567',
    },
