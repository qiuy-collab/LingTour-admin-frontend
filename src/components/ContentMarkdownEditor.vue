...
<style scoped>
.body-editor { display: grid; gap: 8px; width: 100%; min-width: 0; }
.body-label { display: flex; align-items: baseline; gap: 7px; color: var(--lt-text-secondary); font-size: 11px; line-height: 1.2; }
.body-label strong { color: var(--lt-text-regular); font-weight: 650; }
.body-label small { color: var(--lt-text-placeholder); font-size: 10px; }
</style>
